...
for i = 1:n % We have to construct the local F and K of the n triangles
    ...
    % Storing the Bloc matrix in the B matrix
...
% temperature of the other points we have to first eliminate the lines and
...
title("Temperature plot of the coarse mesh with circular obstacle")
xlabel("X")
ylabel("Y")
colorbar
...
title("Flux plot of the coarse mesh with circular obstacle")
xlabel("X")
ylabel("Y")
